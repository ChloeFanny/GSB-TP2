...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pg_gsb_frais_dafconnection
        if ($pathinfo === '/dafconnection') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\HomeController::indexAction',  '_route' => 'pg_gsb_frais_dafconnection',);
        }

        // pg_gsb_frais_affectertablettes
        if ($pathinfo === '/affectertablettes') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\HomeController::affectertablettesAction',  '_route' => 'pg_gsb_frais_affectertablettes',);
        }

        // pg_gsb_frais_validerfrais
        if ($pathinfo === '/validerfrais') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\HomeController::validerfraisAction',  '_route' => 'pg_gsb_frais_validerfrais',);
        }
